...
if(isset($_REQUEST['action'])){
	switch($_REQUEST['action']){
		case'registrar':
		$insert=new crud();
		$insert->insertar($_POST["cod_assistance"],$_POST["student_user_id_user"],$_POST["student_user_document_type_cod_document"],$_POST["matter_has_grade_matter_name_matter"],$_POST["matter_has_grade_grade_desc_grade"]);
		break;
		case 'actualizar':
		$update=new crud();
		$update->actualizar($_POST["id2"],$_POST["cod_assistance"],$_POST["student_user_id_user"],$_POST["student_user_document_type_cod_document"],$_POST["matter_has_grade_matter_name_matter"],$_POST["matter_has_grade_grade_desc_grade"]);
		break;
		case 'eliminar':
			$delete=new crud();
